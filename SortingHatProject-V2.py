...
# HTML GENERATION, displays question alongside question buttons.
def make_question_page(index):
    ...
    button {{
        width: 260px; height:55px; margin:12px;
        font-size:19px; border:none; border-radius:10px;
    ...
    """
    return html
#After all questions are answered, indicate the hats actions.
def final_result():
...
while True:
    ...
    # Ignore favicon requests to prevent webpage reset.
