...
def df_send(cmd, param, feedback=0x00):
    """Send a DFPlayer Mini command properly formatted."""
    high = (param >> 8) & 0xFF
    low = param & 0xFF
    msg = bytearray([
...
while True:
    ...
    if match:
        ...
        if current_question >= len(questions):
            ...
            # Play DFPlayer track AFTER closing connection
            play_mp3(track_num)
